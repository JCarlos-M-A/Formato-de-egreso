...
export function genFPortadaEmpastado(accion, datosFPortada) {
    ...
    doc.setFontSize(12);
    doc.text(datosFPortada.nJefeCarrera, 132, 70);
    doc.setFontSize(7);
    ...
    ///
    doc.setFontSize(11);
    let lugar = datosFPortada.municipio + ", " + datosFPortada.estado;
    let fecha = datosFPortada.fecha.getDate() + ' de ' + datosFPortada.meses[datosFPortada.fecha.getMonth()] + ' del ' + datosFPortada.fecha.getFullYear();
